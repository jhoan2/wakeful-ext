...
export default function YoutubeCaption({ styles, subtitle, currentTime, currentTabId }) {
    ...
    return (
        ...
        <div key={subtitle.start} id={subtitleId} className={`p-2 m-2 border border-gray-300 rounded-lg hover:bg-gray-100 text-md max-w-md `} onClick={() => injectChangeVideoTime(subtitle)}>
            {subtitle.text}
        </div>
    )
}
